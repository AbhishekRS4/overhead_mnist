...
class ComplexResNetV2(nn.Module):
    def __init__(
        self, num_classes: int = 10, list_num_res_units_per_block: List = [4, 4, 4]
    ):
        """
...
class SimpleResKANet(nn.Module):
    def __init__(
        self,
        num_classes: int = 10,
        list_num_res_units_per_block: List = [3, 3],
        device: str = "cuda",
    ):
        """
        ---------
        ...
        self.avg_pool = nn.AdaptiveAvgPool2d((1, 1))
        self.kan_layer = KANLayer(64, num_classes, num=10, device=device)
...
class ComplexResKANet(nn.Module):
    def __init__(
        self,
        num_classes: int = 10,
        list_num_res_units_per_block: List = [4, 4, 4],
        device: str = "cuda",
    ):
        """
        ---------
        ...
        self.avg_pool = nn.AdaptiveAvgPool2d((1, 1))
        self.kan_layer = KANLayer(128, num_classes, num=10, device=device)
...
class ComplexResKANetV2(nn.Module):
    def __init__(
        self,
        num_classes: int = 10,
        list_num_res_units_per_block: List = [4, 4, 4],
